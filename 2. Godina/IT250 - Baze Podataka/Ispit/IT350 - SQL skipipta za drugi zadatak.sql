...
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3451, 503, 'ZX6488', '2019-01-01', '2019-06-23', '2019-06-30');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3465, 503, 'ZX5373', '2019-12-15', '2020-12-14', '2019-05-21');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3467, 616, 'ZX7283', '2019-02-05', '2019-12-02', '2019-10-09');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3452, 617, 'ZX5464', '2019-01-04', '2019-01-03', '2019-01-21');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3469, 616, 'ZX5382', '2019-01-16', '2019-04-08', '2019-04-18');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3145, 503, 'ZX5731', '2019-02-17', '2019-12-20', '2019-12-30');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3425, 504, 'ZX6821', '2019-02-22', '2019-05-25', '2019-06-04');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3427, 616, 'ZX5921', '2019-02-01', '2019-03-02', '2019-04-02');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3189, 616, 'ZX5823', '2019-03-07', '2019-11-05', '2019-11-12');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3470, 616, 'ZX5173', '2019-04-20', '2019-10-05', '2019-10-15');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3125, 617, 'ZX1386', '2019-02-12', '2019-02-01', '2019-02-22');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3128, 617, 'ZX7634', '2019-01-07', '2019-05-07', '2019-05-18');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3565, 503, 'ZX5830', '2019-01-19', '2019-11-15', '2019-12-15');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3201, 617, 'ZX7472', '2019-02-15', '2019-10-15', '2019-10-27');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3223, 618, 'ZX1037', '2019-03-06', '2019-09-16', '2019-09-30');
INSERT INTO `aircraft` (`AircraftID`, `AircraftTypeID`, `RegNum`, `LastMaintEnd`, `NextMaintBegin`, `NextMaintEnd`) VALUES(3130, 616, 'ZX7391', '2019-02-15', '2019-04-15', '2019-05-15');
...
INSERT INTO `aircrafttype` (`AircraftTypeID`, `AircraftName`) VALUES(505, 'Boeing 777');
...
INSERT INTO `aircrafttype` (`AircraftTypeID`, `AircraftName`) VALUES(619, 'Airbus A380SW');
...
INSERT INTO `pax` (`RecordID`, `FlightID`, `FlightDate`, `ClassID`, `PaxName`, `PaxRef`, `Note`) VALUES(197, 652, '2019-06-22', 2, 'Henry Rabbit', 'TG75850303', '');
INSERT INTO `pax` (`RecordID`, `FlightID`, `FlightDate`, `ClassID`, `PaxName`, `PaxRef`, `Note`) VALUES(198, 652, '2019-06-22', 3, 'Harry Hippo', 'TG75847493', '');
INSERT INTO `pax` (`RecordID`, `FlightID`, `FlightDate`, `ClassID`, `PaxName`, `PaxRef`, `Note`) VALUES(199, 652, '2019-06-22', 3, 'Henrietta Hippo', 'TG75847493', '');
...
INSERT INTO `route` (`RouteID`, `FromAirport`, `ToAirport`, `Distance`, `Duration`, `Status`) VALUES(1023, 48, 59, 1434, 150, 0);
...
INSERT INTO `route` (`RouteID`, `FromAirport`, `ToAirport`, `Distance`, `Duration`, `Status`) VALUES(1141, 126, 201, 3913, 320, 0);
...
INSERT INTO `route` (`RouteID`, `FromAirport`, `ToAirport`, `Distance`, `Duration`, `Status`) VALUES(1193, 201, 92, 10310, 760, 0);
...
INSERT INTO `route` (`RouteID`, `FromAirport`, `ToAirport`, `Distance`, `Duration`, `Status`) VALUES(1139, 83, 87, 2474, 150, 0);
...
INSERT INTO `route` (`RouteID`, `FromAirport`, `ToAirport`, `Distance`, `Duration`, `Status`) VALUES(1059, 165, 62, 978, 130, 0);
...
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(652, '2019-06-20', 2, 9, 200);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(652, '2019-06-20', 3, 17, 50);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-07-23', 1, 10, 300);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-06-30', 2, 85, 250);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-06-24', 3, 100, 35);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-07-18', 1, 3, 300);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-07-08', 2, 3, 250);
INSERT INTO `stats` (`FlightID`, `FlightDate`, `ClassID`, `CurrSeats`, `CurrPrice`) VALUES(876, '2019-03-08', 3, 3, 35);